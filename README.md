# <div align='center'>lutpiioffc</div>

<p align="center">

  <img src="https://ziperrimg2.lovable.app/f/a3ke3knfbf.jpg" width="180" alt="lutpiioffc"/>
...
[![GitHub](https://img.shields.io/badge/source-GitHub-black.svg)](https://github.com/lutpiioffc/baileys)
[![Node](https://img.shields.io/badge/node-%3E%3D20-brightgreen.svg)](package.json)

A WebSockets library for interacting with WhatsApp Web, maintained under the **lutpiioffc** brand.
...
```bash
npm install github:lutpiioffc/baileys
```

Or add it to your `package.json` manually:
```json
"dependencies": {
  "@lutpiioffc/baileys": "github:lutpiioffc/baileys"
}
```
...
```json
"dependencies": {
  "@whiskeysockets/baileys": "github:lutpiioffc/baileys"
}
```
...
```bash
npm install github:lutpiioffc/baileys#main
```
...
const client = makeWASocket({
  browser: Browsers.lutpiioffc('Chrome'),
...
await client.relayMessage(m.chat, {
  conversation: "Hello from lutpiioffc"
}, {
  noSelfSync: true
});
...
## Send image
```javascript
await client.sendImage(m.chat, { url: "./ziperr.jpg" }, "Caption", {
  contextInfo: {
    mentionedJid: [m.chat]
  }
}, {
...
## Send audio
```javascript
await client.sendAudio(m.chat, { url: "./ziperraudio.mp3" }, {
  contextInfo: {
    mentionedJid: [m.chat]
  }
}, {
...
lutpiioffc is a fork of [Baileys](https://github.com/WhiskeySockets/Baileys), originally created by
